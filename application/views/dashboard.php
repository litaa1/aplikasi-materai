          ...
          <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1>SELAMAT DATANG DI KANTOR POS KAMI</h1>
<h>KPC TASIKMALAYA</h>
<br>
</br>
<br>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-10">
                        ...
                        <h1 class="h3 mb-1 text-gray-800">Jenis materai</h1>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">MATERAI
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
